...
namespace DLEF
{
    ...
    public partial class ControlEscolarEntities : DbContext
    {
        ...
        public virtual ObjectResult<AlumnoMateriaGetMateriasAsignadas_Result> AlumnoMateriaGetMateriasAsignadas(Nullable<int> idAlumno)
        {
            var idAlumnoParameter = idAlumno.HasValue ?
                new ObjectParameter("IdAlumno", idAlumno) :
                new ObjectParameter("IdAlumno", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<AlumnoMateriaGetMateriasAsignadas_Result>("AlumnoMateriaGetMateriasAsignadas", idAlumnoParameter);
        }
